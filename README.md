...
GIPHY API used to create a dynamic web page populated with gifs of choice. The assignment was completed by calling the GIPHY API and using JavaScript and jQuery to change the HTML.
